				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProduct }" var="hotpro">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							...
							<p><font color="#E4393C" style="font-size:16px">&yen;</font>${hotpro.shop_price }</p>
						</div>
					</c:forEach>
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProduct }" var="newpro">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="${pageContext.request.contextPath }/productInfo?pid=${newpro.pid }">
								<img src="${pageContext.request.contextPath }/${newpro.pimage }" width="130" height="130" style="display: inline-block;">
							</a>
							<p><a href="${pageContext.request.contextPath }/productInfo?pid=${newpro.pid }" style='color:#666'>${newpro.pname }</a></p>
