...
<script type="text/javascript">
	//点击加入购物车按钮
	function addCart(){
		var buyNum = $("#quantity").val();//点击进来，通过id获取商品数量
		location.href="${pageContext.request.contextPath }/product?method=addProductToCart&pid=${product.pid }&buyNum="+buyNum;// 点击来到购物车模块。此处servlet代码被抽取到了ProductServlet中
	}
</script>
	...
	<div class="container">
		<div class="row">
			<div
				...
				<a href="./index.htm">首页&nbsp;&nbsp;&gt;</a> <a href="${pageContext.request.contextPath }/productListByCid?cid=${cid}&currentPage=${currentPage }">返回上一级&nbsp;&nbsp;&gt;</a>
				<a>${product.pname }</a>
			</div>
