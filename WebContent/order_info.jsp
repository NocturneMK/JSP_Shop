...
<script type="text/javascript">
	/* 
	点击确认订单按钮
	1.将用户填写好的地址，姓名，电话 存到数据库中
	2.支付成功，将数据库中的数据state改为1
	*/
...
<body>
	...
	<div class="container">
						...
						<c:forEach items="${order.orderItem }" var="oi">
							<tr class="active">
								<td width="60" width="40%"><input type="hidden" name="id"
									value="22"> <img src="${pageContext.request.contextPath }/${oi.product.pimage }" width="70"
									height="60"></td>
								<td width="30%"><a target="_blank"> ${oi.product.pname }</a></td>
		...
		<div>
			<hr />
			<form id="formorder" class="form-horizontal" action="${pageContext.request.contextPath }/product" method="post"
