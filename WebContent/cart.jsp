...
<html>
	...
	<script type="text/javascript">
		function delProCart(pid){
			if(confirm("您确定删除该条商品吗？")){
				location.href="${pageContext.request.contextPath}/product?method=delProCart&pid=" + pid;
			}
		}
		
		function removeCart(){
			if(confirm("您确定要清空购物车吗？")){
				location.href="${pageContext.request.contextPath}/product?method=removeCart";
			}
		}
	...
	<body>
		...
		<c:if test="${empty cart.cartItems }">
			<!-- 购物车为空 -->
			<h1 style="color:red">您还没有添加商品</h1>
		</c:if>
			...
			<div class="container">
							...
							<tbody>
								...
								<c:forEach items="${cart.cartItems }" var="entry">
									<tr class="active">
										...
										<td>
											<a href="javascript:;" onclick="delProCart('${entry.value.product.pid}')" class="delete">删除</a>
										</td>
									</tr>
				...
				<div style="margin-right:130px;">
					...
					<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
						<a href="javascript:;" id="clear" onclick="removeCart()" class="clear">清空购物车</a>
						<a href="${pageContext.request.contextPath }/product?method=buttonOrder">
